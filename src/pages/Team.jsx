...
const Team = () => {
  ...
  const teamMembers = [
    ...
    },
    {
      ...
      japanesePosition: 'CEO & 共同創業者',
      location: '서울, 대한민국',
      japaneseLocation: 'ソウル、韓国',
      department: 'leadership',
      image: '/api/placeholder/300/300',
      bio: '일본과 한국의 문화적 차이를 이해하고 이를 바탕으로 혁신적인 비즈니스 모델을 창출하는 것을 전문으로 합니다. 한동대에서 데이터과학을 전공하고, 다양한 프로젝트 경험을 바탕으로 Cammunity를 설립했습니다.',
      japaneseBio: '日本と韓国の文化的差異を理解し、それを基に革新的なビジネスモデルを創造することを専門としています。韓国の大学でデータサイエンスを専攻し、様々なプロジェクトの経験を基にキャミュニティを設立しました。',
      skills: ['전략 기획', '비즈니스 개발', '글로벌 마케팅'],
      japaneseSkills: ['戦略企画', 'ビジネス開発', 'グローバルマーケティング'],
      email: 'jaehun@cammunity.com',
      linkedin: 'https://linkedin.com/in/jaehun-choi',
      github: 'https://github.com/jaehun-choi',
      experience: '2년',
      education: '한동대학교 데이터과학과'
    },
    {
      id: 3,
      name: '장채연',
    ...
    },
    {
      ...
      japanesePosition: 'マーケティングマネージャー',
      location: '도쿄, 일본',
